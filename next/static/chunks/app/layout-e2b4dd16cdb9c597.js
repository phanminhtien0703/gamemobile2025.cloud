    ...
    [177], {
        ...
        25288: (e, l, s) => {
            ...
            let c = (0,
                n.memo)(e => {
                var l, s;
                let { data: n, onPlayVideo: a, idVideo: c, onUrl: r, isPlayVideo: d, isPageEvent: o, valueSearch: h } = e, u = Number(null == n ? void 0 : n.id) === Number(c);
                return (0,
                    t.jsx)("div", {
        ...
        68393: (e, l, s) => {
            ...
            let o = () => (0,
                ...
                u = e => {
                    let { isShow: l, onToggleSidebar: s, goLogout: a, isUser: c } = e, [h, u] = (0,
                        n.useState)(!1), [m, x] = (0,
                        n.useState)(!1), p = () => {
                        u(e => !e)
                    }, j = () => {
                                    ...
                                    children: [(0,
                                        ...
                                        children: [(0,
                                            ...
                                            children: [(0,
                                                t.jsxs)("label", {
                                                onClick: () => {
                                                    f(("https://zalo.me/g/kbqnel556")())
                                                },
                                                role: "button",
                                                children: [" ", (0,
                                                    t.jsx)("https://zalo.me/g/kbqnel556", {}), " Cộng Đồng"]
                                            }), (0,
                                                t.jsx)("i", {
                                        ...
                                        children: (0,
                                            ...
                                            children: (0,
                                                ...
                                                role: "button",
                                                children: [(0,
                                                    t.jsx)("https://www.facebook.com/gamemobile.phoenix", {}), " Hỗ trợ"]
                                            })
                                        })
                                    }), (0,
                                        t.jsxs)("li", {
            ...
            var j = s(96834),
                f = s(54329);
            let g = e => {
                let { onToggleSearch: l, isSearch: s } = e, { activeIdVideo: c, isPlayVideo: r, handle: { onPlayVideo: d } } = (0,
                    a.A)(), [o, h] = (0,
                    n.useState)(""), [u, g] = (0,
                    n.useState)(null), [v, b] = (0,
                    n.useState)(!1), [C, N] = (0,
                    n.useState)(0), y = e => {
                    e.preventDefault(),
                        o && b(!0)
            ...
            let b = () => {
                ...
                let l = (0,
                    ...
                    s = (0,
                        v.usePathname)();
                console.log("=======", l);
                let { isSearch: c, handle: { onToggleSearch: r } } = l, [h, m] = (0,
                    n.useState)(!1), [x, p] = (0,
                    n.useState)(!1);
                (0,
                    n.useEffect)(() => {
            ...
            var C = s(64705);
            let N = e => {
                let { isMountFooter: l, isHiddenFooter: s } = e, { isSearch: n, handle: { onToggleSearch: i } } = (0,
                    a.A)(), c = (0,
                    v.usePathname)(), r = "";
        ...
        69243: (e, l, s) => {
            ...
            function f(e) {
                let {
                    ...
                    stylesheets: m,
                    ...p
                } = e, { updateScripts: j, scripts: f, getIsSsr: g, appDir: v, nonce: b } = (0,
                    c.useContext)(r.HeadManagerContext), C = (0,
                    c.useRef)(!1);
                (0,
                    c.useEffect)(() => {
                    let e = l || s;
